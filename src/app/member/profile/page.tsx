    ...
    try {
      ...
      if (response.ok) {
        ...
        setProfileForm((prev) => ({
          ...
          middleName: typeof u.middleName === 'string' ? u.middleName : (u.middleName === null ? '' : prev.middleName),
              ...
              <div className="rounded-2xl border border-zinc-200 dark:border-zinc-800 bg-white dark:bg-zinc-900 p-5">
                ...
                <div className="mt-4 pt-4 border-t border-zinc-200/70 dark:border-zinc-800/70 space-y-2 text-sm">
                  <div className="flex items-center justify-between gap-3">
                    ...
                    <span className="text-zinc-900 dark:text-zinc-100 font-medium">Member</span>
                  </div>
                  {user?.shiftTag ? (
                    <div className="flex items-center justify-between gap-3">
                      <span className="text-zinc-500 dark:text-zinc-400">Shift</span>
                      <span className="text-zinc-900 dark:text-zinc-100 font-medium">
                        {user.shiftTag === 'day' ? 'Day' : user.shiftTag === 'night' ? 'Night' : 'Mixed'}
                      </span>
                    </div>
                  ) : null}
                </div>
              ...
              <div className="p-5 sm:p-6">
                ...
                <form onSubmit={handleProfileUpdate} className="space-y-4">
                  ...
                  <div>
                    ...
                    <div className="mt-1 grid grid-cols-1 sm:grid-cols-3 gap-3">
                      <input
                        type="text"
                        required
                        className="block w-full px-3 py-2 border border-zinc-300 dark:border-zinc-700 bg-white dark:bg-gray-900 text-gray-900 dark:text-gray-200 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 dark:focus:ring-indigo-600 dark:focus:border-indigo-600 sm:text-sm"
                        placeholder="First"
                  ...
                  <div>
                    ...
                    <p className="mt-1 text-sm text-zinc-900 dark:text-zinc-100 bg-zinc-50 dark:bg-zinc-900 px-3 py-2 rounded-md border border-zinc-200 dark:border-zinc-800 flex items-center gap-2">
                  ...
                  {user?.shiftTag && (
                    <div>
                      <label className="block text-sm font-medium text-zinc-700 dark:text-zinc-300">Shift Type</label>
                      <p className="mt-1 text-sm text-zinc-900 dark:text-zinc-100 bg-zinc-50 dark:bg-zinc-900 px-3 py-2 rounded-md border border-zinc-200 dark:border-zinc-800">
                  ...
                  {user?.workingDaysTag && (
                    <div>
                      <label className="block text-sm font-medium text-zinc-700 dark:text-zinc-300 mb-2">Working Days Pattern</label>
